...
|	"INTERVAL" Expression TimeUnit "PRECEDING"
	{
		$$ = ast.FrameBound{Type: ast.Preceding, Expr: ast.NewValueExpr($2), Unit: $3.(ast.TimeUnitType),}
	}
|	"CURRENT" "ROW"
	{
...
|	"INTERVAL" Expression TimeUnit "FOLLOWING"
	{
		$$ = ast.FrameBound{Type: ast.Following, Expr: ast.NewValueExpr($2), Unit: $3.(ast.TimeUnitType),}
	}
